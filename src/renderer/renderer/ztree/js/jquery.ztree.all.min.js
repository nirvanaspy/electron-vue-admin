...
function() { return e.getNextNode(a, c) }; c.getIndex = function() { return e.getNodeIndex(a, c) }; c.getPath = function() { return e.getNodePath(a, c) }; c.isAjaxing = !1; e.fixPIdKeyValue(a, c)
      ...
      var b = a.target, c = e.getSetting(a.data.treeId), d = '', g = null, h = '', k = '', m = null, i = null, o = null; if (j.eqs(a.type, 'mousedown'))k = 'mousedown'; else if (j.eqs(a.type, 'mouseup'))k = 'mouseup'; else if (j.eqs(a.type, 'contextmenu'))k = 'contextmenu'; else if (j.eqs(a.type, 'click')) {
        if (j.eqs(b.tagName, 'span') && b.getAttribute('treeNode' +
f.id.SWITCH) !== null)d = j.getNodeMainDom(b).id, h = 'switchNode'; else { if (o = j.getMDom(c, b, [{ tagName: 'a', attrName: 'treeNode' + f.id.A }]))d = j.getNodeMainDom(o).id, h = 'clickNode' }
      } else if (j.eqs(a.type, 'dblclick') && (k = 'dblclick', o = j.getMDom(c, b, [{ tagName: 'a', attrName: 'treeNode' + f.id.A }])))d = j.getNodeMainDom(o).id, h = 'switchNode'; if (k.length > 0 && d.length == 0 && (o = j.getMDom(c, b, [{ tagName: 'a', attrName: 'treeNode' + f.id.A }])))d = j.getNodeMainDom(o).id; if (d.length > 0) {
        switch (g = e.getNodeCache(c, d), h) {
...
[], f = {}; for (c = 0, d = b.length; c < d; c++)f[b[c][g]] = b[c]; for (c = 0, d = b.length; c < d; c++) { var i = f[b[c][h]]; if (i && b[c][g] != b[c][h]) { var o = e.nodeChildren(a, i); o || (o = e.nodeChildren(a, i, [])); o.push(b[c]) } else k.push(b[c]) } return k
      ...
      } }, n = { bindEvent: function(a) { for (var b = 0, c = x.length; b < c; b++)x[b].apply(this, arguments) }, unbindEvent: function(a) { for (var b = 0, c = y.length; b < c; b++)y[b].apply(this, arguments) }, bindTree: function(a) {
...
[], c = 0, d = t.length; c < d; c++) { var e = t[c].apply(this, arguments); b.push(e); if (e.stop) break } return b
    }, proxy: function(a) { var b = e.getSetting(a.data.treeId); if (!j.uCanDo(b, a)) return !0; for (var b = n.doProxy(a), c = !0, d = 0, g = b.length; d < g; d++) { var h = b[d]; h.nodeEventCallback && (c = h.nodeEventCallback.apply(h, [a, h.node]) && c); h.treeEventCallback && (c = h.treeEventCallback.apply(h, [a, h.node]) && c) } return c } }; H = function(a, b) {
...
!1) return !0
  ...
  M = function(a, b) { var c = e.getSetting(a.data.treeId); j.apply(c.callback.beforeRightClick, [c.treeId, b], !0) && j.apply(c.callback.onRightClick, [a, c.treeId, b]); return typeof c.callback.onRightClick !== 'function' }; u = function(a) { a = a.originalEvent.srcElement.nodeName.toLowerCase(); return a === 'input' || a === 'textarea' }; var j = { apply: function(a, b, c) { return typeof a === 'function' ? a.apply(O, b || []) : c }, canAsync: function(a, b) {
...
0)
      ...
      return q(a).closest('#' +
b).length > 0
    }, uCanDo: function() { return !0 } }, i = { addNodes: function(a, b, c, d, g) {
      var h = e.nodeIsParent(a, b); if (!a.data.keep.leaf || !b || h) {
        if (j.isArray(d) || (d = [d]), a.data.simpleData.enable && (d = e.transformTozTreeFormat(a, d)), b) { var h = l(b, f.id.SWITCH, a), k = l(b, f.id.ICON, a), m = l(b, f.id.UL, a); if (!b.open)i.replaceSwitchClass(b, h, f.folder.CLOSE), i.replaceIcoClass(b, k, f.folder.CLOSE), b.open = !1, m.css({ display: 'none' }); e.addNodesData(a, b, c, d); i.createNodes(a, b.level + 1, d, b, c); g || i.expandCollapseParentNode(a, b, !0) } else {
          e.addNodesData(a,
            e.getRoot(a), c, d), i.createNodes(a, 0, d, null, c)
        }
      }
    }, appendNodes: function(a, b, c, d, g, h, k) {
      if (!c) return []; var f = [], j = d || e.getRoot(a), j = e.nodeChildren(a, j), o, l; if (!j || g >= j.length - c.length)g = -1; for (var n = 0, Q = c.length; n < Q; n++) {
...
r; r.length > 1 && (o = r[1], r = r[0]); k[o] = b[r]
      }m = j.apply(a.async.otherParam, [a.treeId, b], a.async.otherParam); if (j.isArray(m)) for (g = 0, h = m.length; g < h; g += 2)k[m[g]] = m[g + 1]; else for (var n in m)k[n] = m[n]; var P = e.getRoot(a)._ver; q.ajax({ contentType: a.async.contentType, cache: !1, type: a.async.type, url: j.apply(a.async.url, [a.treeId, b], a.async.url), data: a.async.contentType.indexOf('application/json') > -1 ? JSON.stringify(k) : k, dataType: a.async.dataType, success: function(h) {
...
0 ? [] : typeof h === 'string' ? eval('(' + h + ')') : h
      ...
      }, error: function(c, d, h) { if (P == e.getRoot(a)._ver) { if (b)b.isAjaxing = null; i.setNodeLineIcos(a, b); a.treeObj.trigger(f.event.ASYNC_ERROR, [a.treeId, b, c, d, h]) } } }); return !0
...
b.iconClose && o.attr('style', i.makeNodeIcoStyle(a, b)), b.open ? (i.replaceSwitchClass(b, h, f.folder.OPEN), i.replaceIcoClass(b, o, f.folder.OPEN), d == !1 || a.view.expandSpeed == '' ? (c.show(), j.apply(g, [])) : m && m.length > 0 ? c.slideDown(a.view.expandSpeed, g) : (c.show(), j.apply(g, []))) : (i.replaceSwitchClass(b, h, f.folder.CLOSE), i.replaceIcoClass(b, o, f.folder.CLOSE), d == !1 || a.view.expandSpeed == '' || !(m && m.length > 0) ? (c.hide(), j.apply(g, [])) : c.slideUp(a.view.expandSpeed, g))) : j.apply(g, [])
      ...
      var d = e.nodeTitle(b, c), g = i.makeNodeUrl(b, c), h = i.makeNodeFontCss(b, c), k = [], m; for (m in h) {
        k.push(m,
          ':', h[m], ';')
...
c.bottom || d.right > c.right || d.left < c.left) && b.scrollIntoView()
          ...
          if (!Element.prototype.scrollIntoViewIfNeeded) {
            Element.prototype.scrollIntoViewIfNeeded = function(a) {
              function b(a, c, d, f) {
                return { left: a, top: c, width: d, height: f, right: a + d, bottom: c + f, translate: function(e, g) { return b(e + a, g + c, d, f) }, relativeFromTo: function(g, k) {
                  var i = a, j = c, g = g.offsetParent, k = k.offsetParent; if (g === k) return e; for (;g; g = g.offsetParent)i += g.offsetLeft + g.clientLeft, j += g.offsetTop + g.clientTop; for (;k; k = k.offsetParent) {
                    i -= k.offsetLeft +
...
c.scrollTop + c.clientHeight && c.scrollTop <= e.bottom - c.clientHeight + c.clientHeight ? Math.min(e.top, Math.max(e.bottom - c.clientHeight, c.scrollTop)) : (e.bottom - c.clientHeight + e.top) / 2; e = e.translate(f - c.scrollLeft, i - c.scrollTop); d = c
      ...
      var c = e.getRoot(a), d = b.parentTId ? b.getParentNode()
        ...
        l(b, a).remove(); e.removeNodeCache(a, b); e.removeSelectedNode(a, b); for (var g = e.nodeChildren(a, d), h = 0, k = g.length; h < k; h++) if (g[h].tId == b.tId) { g.splice(h, 1); break }i.setFirstNode(a, d); i.setLastNode(a, d); var j, h = g.length; if (!a.data.keep.parent && h == 0) {
          e.nodeIsParent(a, d, !1), d.open = !1, delete d[a.data.key.children], h = l(d, f.id.UL, a), k = l(d, f.id.SWITCH, a), j = l(d, f.id.ICON, a),
          i.replaceSwitchClass(d, k, f.folder.DOCU), i.replaceIcoClass(d, j, f.folder.DOCU), h.css('display', 'none')
        } else if (a.view.showLine && h > 0) { var r = g[h - 1], h = l(r, f.id.UL, a), k = l(r, f.id.SWITCH, a); j = l(r, f.id.ICON, a); d == c ? g.length == 1 ? i.replaceSwitchClass(r, k, f.line.ROOT) : (c = l(g[0], f.id.SWITCH, a), i.replaceSwitchClass(g[0], c, f.line.ROOTS), i.replaceSwitchClass(r, k, f.line.BOTTOM)) : i.replaceSwitchClass(r, k, f.line.BOTTOM); h.removeClass(f.line.LINE) }
      }
...
!b, i.switchNode(this.setting, a), n()); return b
    ...
    }, removeChildNodes: function(a) { if (!a) return null; var b = e.nodeChildren(d, a); i.removeChildNodes(d, a); return b || null }, removeNode: function(a, b) { a && (b = !!b, b && j.apply(d.callback.beforeRemove, [d.treeId, a], !0) == !1 || (i.removeNode(d, a), b && this.setting.treeObj.trigger(f.event.REMOVE, [d.treeId, a]))) }, selectNode: function(a, b, c) {
...
(function(n) {
  var q, r, s, p = { event: { CHECK: 'ztree_check' }, id: { CHECK: '_check' }, checkbox: { STYLE: 'checkbox', DEFAULT: 'chk', DISABLED: 'disable', FALSE: 'false', TRUE: 'true', FULL: 'full', PART: 'part', FOCUS: 'focus' }, radio: { STYLE: 'radio', TYPE_ALL: 'all', TYPE_LEVEL: 'level' }}, w = { check: { enable: !1, autoCheckTrigger: !1, chkStyle: p.checkbox.STYLE, nocheckInherit: !1, chkDisabledInherit: !1, radioType: p.radio.TYPE_LEVEL, chkboxType: { Y: 'ps', N: 'ps' }}, data: { key: { checked: 'checked' }}, callback: { beforeCheck: null, onCheck: null }}; q = function(c,
    ...
    a) { if (a.chkDisabled === !0) return !1; var b = e.getSetting(c.data.treeId), d = m(a, h.id.CHECK, b); a.check_Focus = !1; f.setChkClass(b, d, a); return !0 }; n.extend(!0, n.fn.zTree.consts, p); n.extend(!0, n.fn.zTree._z, { tools: {}, view: { checkNodeRelation: function(c, a) {
    var b, d, j; d = h.radio; b = e.nodeChecked(c, a); if (c.check.chkStyle == d.STYLE) {
      var g = e.getRadioCheckedList(c); if (b) {
        ...
        } else { g = a.parentTId ? a.getParentNode() : e.getRoot(c); g = e.nodeChildren(c, g); for (d = 0, j = g.length; d < j; d++) if (b = g[d], (k = e.nodeChecked(c, b)) && b != a)e.nodeChecked(c, b, !1), f.setChkClass(c, m(b, h.id.CHECK, c), b) }
      } else if (c.check.radioType == d.TYPE_ALL) for (d = 0, j = g.length; d < j; d++) if (a == g[d]) { g.splice(d, 1); break }
    } else {
      g = e.nodeChildren(c, a), b && (!g || g.length == 0 || c.check.chkboxType.Y.indexOf('s') > -1) && f.setSonNodeCheckBox(c, a,
...
m(a, h.id.CHECK, c); f.setChkClass(c, b, a)
    ...
    if (a) {
      if (a.chkDisabled != b)a.chkDisabled = b; f.repairChkClass(c, a); if ((a = e.nodeChildren(c, a)) && d) {
        for (var j = 0, g = a.length; j < g; j++) {
          f.repairSonChkDisabled(c,
            a[j], b, d)
        }
      }
    }
    ...
    if (a) {
      var j = m(a, h.id.CHECK, c); d || (d = a); var g = !1, k = e.nodeChildren(c, a); if (k) {
    ...
    if (a) {
      ...
      if (d) {
        for (var j = 0, g = d.length; j < g; j++) {
          var f = d[j], i = e.nodeChecked(c, f), l = -1; if (c.check.chkStyle == h.radio.STYLE) if (l = f.nocheck === !0 || f.chkDisabled === !0 ? f.check_Child_State : f.halfCheck === !0 ? 2 : i ? 2 : f.check_Child_State > 0 ? 2 : 0, l == 2) { b = 2; break } else l == 0 && (b = 0); else if (c.check.chkStyle == h.checkbox.STYLE) {
            if (l = f.nocheck === !0 || f.chkDisabled === !0 ? f.check_Child_State : f.halfCheck === !0 ? 1 : i ? f.check_Child_State === -1 || f.check_Child_State === 2 ? 2 : 1 : f.check_Child_State > 0 ? 1 : 0, l === 1) { b = 1; break } else if (l === 2 && b > -1 && j > 0 && l !==
